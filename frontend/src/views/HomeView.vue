  ...
  <div v-else class="landing-page q-pa-md text-center">
      <div class="row justify-center q-my-xl">
        <div class="col-12 col-md-8">
          <img src="@/assets/eipa1.png" style="max-width: 300px;" />
          <h1 class="text-h3 text-weight-bold text-primary q-mt-md">E-IPA</h1>
          <h2 class="text-h5 text-primary q-mt-none">MTSN 1 Kota Makassar</h2>
          <p class="text-h6 text-grey-7 q-mt-md">Sistem Informasi Manajemen Laboratorium IPA Terpadu</p>
          <q-separator class="q-my-md" />
          <p class="text-body1 q-px-lg">
            Selamat datang di E-IPA. Platform ini dirancang untuk memudahkan pengelolaan aset laboratorium, 
            penjadwalan praktikum, dan peminjaman alat secara digital, transparan, dan efisien.
          </p>
        </div>
      </div>
  </div>
